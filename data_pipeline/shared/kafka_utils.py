...
async def get_kafka_consumer(topics: list, group_id: str, bootstrap_servers: str,
                             offset_reset: str = 'earliest') -> AIOKafkaConsumer:
    return AIOKafkaConsumer(*topics, bootstrap_servers=bootstrap_servers, group_id=group_id,
